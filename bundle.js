...
var getExchangeRate = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(from, to) {
        var res, rate;
    ...
    return function getExchangeRate(_x, _x2) {
        return _ref.apply(this, arguments);
    };
}();

var getCuntries = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(currencyCode) {
        var res;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                        res = _context2.sent;
                        return _context2.abrupt('return', res.data.map(function (country) {
                            return country.name;
                        }));
    ...
    return function getCuntries(_x3) {
        return _ref2.apply(this, arguments);
    };
}();

var convertCurrencyAsync = function () {
    var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(from, to, amount) {
        var countries, rate, exchAmm;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return getCuntries(from);
                    ...
                    case 5:
                        rate = _context3.sent;
                        exchAmm = amount * rate;
                        return _context3.abrupt('return', 'Async: ' + amount + ' ' + from + ' is worth ' + exchAmm + ' ' + to + '. ' + from + ' currency can be used in ALL the following countries: ' + countries.join(', '));
    ...
    return function convertCurrencyAsync(_x4, _x5, _x6) {
        return _ref3.apply(this, arguments);
    };
}();

var convertCurrency = function convertCurrency(from, to, amount) {
    var countries = void 0;
    return getCuntries(to).then(function (tempCountries) {
        countries = tempCountries;
        return getExchangeRate(from, to);
    }).then(function (rate) {
        var exchAmm = amount * rate;
...
convertCurrencyAsync('EUR', 'USD', 140).then(function (status) {
